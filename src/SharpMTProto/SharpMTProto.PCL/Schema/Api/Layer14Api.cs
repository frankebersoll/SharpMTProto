...
//     Generated at 07/21/2014 01:02:16
//
...
namespace SharpMTProto.Schema.Api
{
    ...
    [TLObject(0x2B9B08FA)]
    public partial class InvokeWithLayer14Args
    {
        [TLProperty(1)]
        public System.Object Query { get; set; }
    ...
    public interface IInputFileLocation
    {
    }

    [TLType(typeof(InputPhotoCropAuto), typeof(InputPhotoCrop))]
    public interface IInputPhotoCrop
    {
    }

    [TLType(typeof(InputAppEvent))]
    public interface IInputAppEvent
    {
    ...
    public interface IStorageFileType
    {
    }
    ...
    public interface IMessageMedia
    {
    }
    ...
    public interface IAuthCheckedPhone
    {
    ...
    public interface IAuthSentCode
    {
		System.Boolean PhoneRegistered { get; }
    ...
    public interface IAuthAuthorization
    {
    ...
    public interface IAuthExportedAuthorization
    {
		System.UInt32 Id { get; }
    ...
    public interface IInputNotifyPeer
    {
    }

    [TLType(typeof(InputPeerNotifyEventsEmpty), typeof(InputPeerNotifyEventsAll))]
    public interface IInputPeerNotifyEvents
    {
    }
    ...
    public interface IPeerNotifyEvents
    {
    }

    [TLType(typeof(PeerNotifySettingsEmpty), typeof(PeerNotifySettings))]
    public interface IPeerNotifySettings
    {
    }
    ...
    public interface IImportedContact
    {
		System.UInt32 UserId { get; }
		System.UInt64 ClientId { get; }
    }
    ...
    public interface IContactBlocked
    {
		System.UInt32 UserId { get; }
		System.UInt32 Date { get; }
    }
    ...
    public interface IContactFound
    {
		System.UInt32 UserId { get; }
    }

    [TLType(typeof(ContactSuggested))]
    public interface IContactSuggested
    {
		System.UInt32 UserId { get; }
    ...
    public interface IContactsContacts
    {
    }

    [TLType(typeof(ContactsImportedContacts))]
    public interface IContactsImportedContacts
    {
    ...
    public interface IContactsBlocked
    {
    ...
    public interface IContactsFound
    {
    ...
    public interface IContactsSuggested
    {
    ...
    public interface IMessagesDialogs
    {
    ...
    public interface IMessagesMessage
    {
    }

    [TLType(typeof(MessagesStatedMessages), typeof(MessagesStatedMessagesLinks))]
    public interface IMessagesStatedMessages
    {
		System.Collections.Generic.List<IMessage> Messages { get; }
		System.Collections.Generic.List<IChat> Chats { get; }
		System.Collections.Generic.List<IUser> Users { get; }
    ...
    public interface IMessagesStatedMessage
    {
    ...
    public interface IMessagesSentMessage
    {
		System.UInt32 Id { get; }
		System.UInt32 Date { get; }
		System.UInt32 Pts { get; }
    ...
    public interface IMessagesChat
    {
		IChat Chat { get; }
		System.Collections.Generic.List<IUser> Users { get; }
    }
    ...
    public interface IMessagesChats
    {
		System.Collections.Generic.List<IChat> Chats { get; }
		System.Collections.Generic.List<IUser> Users { get; }
    }
    ...
    public interface IMessagesChatFull
    {
    ...
    public interface IMessagesAffectedHistory
    {
		System.UInt32 Pts { get; }
		System.UInt32 Seq { get; }
    ...
    public interface IUpdatesState
    {
		System.UInt32 Pts { get; }
    ...
    public interface IUpdatesDifference
    {
    }
    ...
    public interface IPhotosPhotos
    {
    ...
    public interface IHelpAppUpdate
    {
    }

    [TLType(typeof(HelpInviteText))]
    public interface IHelpInviteText
    {
		System.String Message { get; }
    }

    [TLType(typeof(InputGeoChat))]
    public interface IInputGeoChat
    {
		System.UInt32 ChatId { get; }
    ...
    public interface IGeoChatMessage
    {
		System.UInt32 ChatId { get; }
		System.UInt32 Id { get; }
    }
    ...
    public interface IGeochatsStatedMessage
    {
    ...
    public interface IGeochatsLocated
    {
    ...
    public interface IGeochatsMessages
    {
		System.Collections.Generic.List<IGeoChatMessage> Messages { get; }
		System.Collections.Generic.List<IChat> Chats { get; }
		System.Collections.Generic.List<IUser> Users { get; }
    ...
    public interface IEncryptedChat
    {
		System.UInt32 Id { get; }
    }

    [TLType(typeof(InputEncryptedChat))]
    public interface IInputEncryptedChat
    {
		System.UInt32 ChatId { get; }
		System.UInt64 AccessHash { get; }
    }
    ...
    public interface IInputEncryptedFile
    {
    }
    ...
    public interface IDecryptedMessageLayer
    {
    ...
    public interface IDecryptedMessage
    {
		System.UInt64 RandomId { get; }
    ...
    public interface IDecryptedMessageMedia
    {
    }
    ...
    ///		Api async methods.
    /// </summary>
    public interface IApiAsyncMethods
    {
        Task<object> InvokeAfterMsgAsync(InvokeAfterMsgArgs args);
        Task<object> InvokeAfterMsgsAsync(InvokeAfterMsgsArgs args);
        ...
        Task<object> InitConnectionAsync(InitConnectionArgs args);
        Task<IHelpSupport> HelpGetSupportAsync(HelpGetSupportArgs args);
        Task<object> InvokeWithLayer14Async(InvokeWithLayer14Args args);
    }

    /// <summary>
    ///		Api async methods.
    /// </summary>
    public class ApiAsyncMethods : IApiAsyncMethods
    {
		private readonly ITLConnectionAdapter connection;

		public ApiAsyncMethods(ITLConnectionAdapter connection)
		{
			this.connection = connection;
		}
        public Task<object> InvokeAfterMsgAsync(InvokeAfterMsgArgs args)
		{
			return this.connection.Send<object>(args);
		}
        public Task<object> InvokeAfterMsgsAsync(InvokeAfterMsgsArgs args)
		{
			return this.connection.Send<object>(args);
		}
        public Task<IAuthCheckedPhone> AuthCheckPhoneAsync(AuthCheckPhoneArgs args)
		{
			return this.connection.Send<IAuthCheckedPhone>(args);
		}
        public Task<IAuthSentCode> AuthSendCodeAsync(AuthSendCodeArgs args)
		{
			return this.connection.Send<IAuthSentCode>(args);
		}
        public Task AuthSendCallAsync(AuthSendCallArgs args)
		{
			return this.connection.Send<bool>(args);
		}
        public Task<IAuthAuthorization> AuthSignUpAsync(AuthSignUpArgs args)
		{
			return this.connection.Send<IAuthAuthorization>(args);
		}
        public Task<IAuthAuthorization> AuthSignInAsync(AuthSignInArgs args)
		{
			return this.connection.Send<IAuthAuthorization>(args);
		}
        public Task AuthLogOutAsync(AuthLogOutArgs args)
		{
			return this.connection.Send<bool>(args);
		}
        public Task AuthResetAuthorizationsAsync(AuthResetAuthorizationsArgs args)
		{
			return this.connection.Send<bool>(args);
		}
        public Task AuthSendInvitesAsync(AuthSendInvitesArgs args)
		{
			return this.connection.Send<bool>(args);
		}
        public Task<IAuthExportedAuthorization> AuthExportAuthorizationAsync(AuthExportAuthorizationArgs args)
		{
			return this.connection.Send<IAuthExportedAuthorization>(args);
		}
        public Task<IAuthAuthorization> AuthImportAuthorizationAsync(AuthImportAuthorizationArgs args)
		{
			return this.connection.Send<IAuthAuthorization>(args);
		}
        public Task AccountRegisterDeviceAsync(AccountRegisterDeviceArgs args)
		{
			return this.connection.Send<bool>(args);
		}
        public Task AccountUnregisterDeviceAsync(AccountUnregisterDeviceArgs args)
		{
			return this.connection.Send<bool>(args);
		}
        public Task AccountUpdateNotifySettingsAsync(AccountUpdateNotifySettingsArgs args)
		{
			return this.connection.Send<bool>(args);
		}
        public Task<IPeerNotifySettings> AccountGetNotifySettingsAsync(AccountGetNotifySettingsArgs args)
		{
			return this.connection.Send<IPeerNotifySettings>(args);
		}
        public Task AccountResetNotifySettingsAsync(AccountResetNotifySettingsArgs args)
		{
			return this.connection.Send<bool>(args);
		}
        public Task<IUser> AccountUpdateProfileAsync(AccountUpdateProfileArgs args)
		{
			return this.connection.Send<IUser>(args);
		}
        public Task AccountUpdateStatusAsync(AccountUpdateStatusArgs args)
		{
			return this.connection.Send<bool>(args);
		}
        public Task AccountGetWallPapersAsync(AccountGetWallPapersArgs args)
		{
			return this.connection.Send<bool>(args);
		}
        public Task UsersGetUsersAsync(UsersGetUsersArgs args)
		{
			return this.connection.Send<bool>(args);
		}
        public Task<IUserFull> UsersGetFullUserAsync(UsersGetFullUserArgs args)
		{
			return this.connection.Send<IUserFull>(args);
		}
        public Task ContactsGetStatusesAsync(ContactsGetStatusesArgs args)
		{
			return this.connection.Send<bool>(args);
		}
        public Task<IContactsContacts> ContactsGetContactsAsync(ContactsGetContactsArgs args)
		{
			return this.connection.Send<IContactsContacts>(args);
		}
        public Task<IContactsImportedContacts> ContactsImportContactsAsync(ContactsImportContactsArgs args)
		{
			return this.connection.Send<IContactsImportedContacts>(args);
		}
        public Task<IContactsFound> ContactsSearchAsync(ContactsSearchArgs args)
		{
			return this.connection.Send<IContactsFound>(args);
		}
        public Task<IContactsSuggested> ContactsGetSuggestedAsync(ContactsGetSuggestedArgs args)
		{
			return this.connection.Send<IContactsSuggested>(args);
		}
        public Task<IContactsLink> ContactsDeleteContactAsync(ContactsDeleteContactArgs args)
		{
			return this.connection.Send<IContactsLink>(args);
		}
        public Task ContactsDeleteContactsAsync(ContactsDeleteContactsArgs args)
		{
			return this.connection.Send<bool>(args);
		}
        public Task ContactsBlockAsync(ContactsBlockArgs args)
		{
			return this.connection.Send<bool>(args);
		}
        public Task ContactsUnblockAsync(ContactsUnblockArgs args)
		{
			return this.connection.Send<bool>(args);
		}
        public Task<IContactsBlocked> ContactsGetBlockedAsync(ContactsGetBlockedArgs args)
		{
			return this.connection.Send<IContactsBlocked>(args);
		}
        public Task<IMessagesMessages> MessagesGetMessagesAsync(MessagesGetMessagesArgs args)
		{
			return this.connection.Send<IMessagesMessages>(args);
		}
        public Task<IMessagesDialogs> MessagesGetDialogsAsync(MessagesGetDialogsArgs args)
		{
			return this.connection.Send<IMessagesDialogs>(args);
		}
		...
		{
			return this.connection.Send<IMessagesAffectedHistory>(args);
		}
        public Task<IMessagesAffectedHistory> MessagesDeleteHistoryAsync(MessagesDeleteHistoryArgs args)
		{
			return this.connection.Send<IMessagesAffectedHistory>(args);
		}
        public Task MessagesDeleteMessagesAsync(MessagesDeleteMessagesArgs args)
		{
			return this.connection.Send<bool>(args);
		}
        public Task MessagesRestoreMessagesAsync(MessagesRestoreMessagesArgs args)
		{
			return this.connection.Send<bool>(args);
		}
        public Task MessagesReceivedMessagesAsync(MessagesReceivedMessagesArgs args)
		{
			return this.connection.Send<bool>(args);
		}
        public Task MessagesSetTypingAsync(MessagesSetTypingArgs args)
		{
			return this.connection.Send<bool>(args);
		}
        public Task<IMessagesSentMessage> MessagesSendMessageAsync(MessagesSendMessageArgs args)
		{
			return this.connection.Send<IMessagesSentMessage>(args);
		}
        public Task<IMessagesStatedMessage> MessagesSendMediaAsync(MessagesSendMediaArgs args)
		{
			return this.connection.Send<IMessagesStatedMessage>(args);
		}
        public Task<IMessagesStatedMessages> MessagesForwardMessagesAsync(MessagesForwardMessagesArgs args)
		{
			return this.connection.Send<IMessagesStatedMessages>(args);
		}
        public Task<IMessagesChats> MessagesGetChatsAsync(MessagesGetChatsArgs args)
		{
			return this.connection.Send<IMessagesChats>(args);
		}
        public Task<IMessagesChatFull> MessagesGetFullChatAsync(MessagesGetFullChatArgs args)
		{
			return this.connection.Send<IMessagesChatFull>(args);
		}
        ...
        public Task GeochatsSetTypingAsync(GeochatsSetTypingArgs args)
		{
			return this.connection.Send<bool>(args);
		}
		...
		{
			return this.connection.Send<IMessagesDhConfig>(args);
		}
        public Task<IEncryptedChat> MessagesRequestEncryptionAsync(MessagesRequestEncryptionArgs args)
		{
			return this.connection.Send<IEncryptedChat>(args);
		}
        public Task<IEncryptedChat> MessagesAcceptEncryptionAsync(MessagesAcceptEncryptionArgs args)
		{
			return this.connection.Send<IEncryptedChat>(args);
		}
        public Task MessagesDiscardEncryptionAsync(MessagesDiscardEncryptionArgs args)
		{
			return this.connection.Send<bool>(args);
		}
        public Task MessagesSetEncryptedTypingAsync(MessagesSetEncryptedTypingArgs args)
		{
			return this.connection.Send<bool>(args);
		}
        public Task MessagesReadEncryptedHistoryAsync(MessagesReadEncryptedHistoryArgs args)
		{
			return this.connection.Send<bool>(args);
		}
        public Task<IMessagesSentEncryptedMessage> MessagesSendEncryptedAsync(MessagesSendEncryptedArgs args)
		{
			return this.connection.Send<IMessagesSentEncryptedMessage>(args);
		}
        ...
        public Task MessagesReceivedQueueAsync(MessagesReceivedQueueArgs args)
		{
			return this.connection.Send<bool>(args);
		}
        public Task UploadSaveBigFilePartAsync(UploadSaveBigFilePartArgs args)
		{
			return this.connection.Send<bool>(args);
		}
        public Task<object> InitConnectionAsync(InitConnectionArgs args)
		{
			return this.connection.Send<object>(args);
		}
        public Task<IHelpSupport> HelpGetSupportAsync(HelpGetSupportArgs args)
		{
			return this.connection.Send<IHelpSupport>(args);
		}
        public Task<object> InvokeWithLayer14Async(InvokeWithLayer14Args args)
		{
			return this.connection.Send<object>(args);
		}
    }
