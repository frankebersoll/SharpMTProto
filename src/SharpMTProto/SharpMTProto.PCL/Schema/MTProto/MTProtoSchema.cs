...
//     Generated at 07/06/2014 20:30:41
//
...
namespace SharpMTProto.Schema.MTProto
{
    ...
    [TLObject(0x3072CFA1)]
    public partial class GzipPacked : ITLObject
    {
        [TLProperty(1)]
    ...
    [TLObject(0x60469778)]
    public partial class ReqPqArgs : ITLObject
    {
        [TLProperty(1)]
        public BigMath.Int128 Nonce { get; set; }
    ...
    [TLObject(0xD712E4BE)]
    public partial class ReqDHParamsArgs : ITLObject
    {
        [TLProperty(1)]
        public BigMath.Int128 Nonce { get; set; }
    ...
    [TLObject(0xF5045F1F)]
    public partial class SetClientDHParamsArgs : ITLObject
    {
        [TLProperty(1)]
        public BigMath.Int128 Nonce { get; set; }
    ...
    [TLObject(0x58E4A740)]
    public partial class RpcDropAnswerArgs : ITLObject
    {
        [TLProperty(1)]
        public System.UInt64 ReqMsgId { get; set; }
    ...
    [TLObject(0xB921BD04)]
    public partial class GetFutureSaltsArgs : ITLObject
    {
        [TLProperty(1)]
    ...
    [TLObject(0x7ABE77EC)]
    public partial class PingArgs : ITLObject
    {
        [TLProperty(1)]
        public System.UInt64 PingId { get; set; }
    ...
    [TLObject(0xF3427B8C)]
    public partial class PingDelayDisconnectArgs : ITLObject
    {
        [TLProperty(1)]
        public System.UInt64 PingId { get; set; }
    ...
    [TLObject(0xE7512126)]
    public partial class DestroySessionArgs : ITLObject
    {
        [TLProperty(1)]
        public System.UInt64 SessionId { get; set; }
    ...
    [TLObject(0x9299359F)]
    public partial class HttpWaitArgs : ITLObject
    {
        [TLProperty(1)]
    ...
    [TLType(typeof(ResPQ))]
    public interface IResPQ : ITLObject
    {
    ...
    public interface IPQInnerData : ITLObject
    {
		System.Byte[] Pq { get; }
		System.Byte[] P { get; }
		System.Byte[] Q { get; }
    ...
    public interface IServerDHParams : ITLObject
    {
		BigMath.Int128 Nonce { get; }
		BigMath.Int128 ServerNonce { get; }
    }
    ...
    public interface IServerDHInnerData : ITLObject
    {
		BigMath.Int128 Nonce { get; }
		BigMath.Int128 ServerNonce { get; }
		System.UInt32 G { get; }
    ...
    public interface IClientDHInnerData : ITLObject
    {
		BigMath.Int128 Nonce { get; }
		BigMath.Int128 ServerNonce { get; }
    ...
    public interface ISetClientDHParamsAnswer : ITLObject
    {
		BigMath.Int128 Nonce { get; }
		BigMath.Int128 ServerNonce { get; }
    }
    ...
    public interface IRpcResult : ITLObject
    {
    ...
    public interface IRpcError : ITLObject
    {
    ...
    public interface IRpcDropAnswer : ITLObject
    {
    }

    [TLType(typeof(FutureSalt))]
    public interface IFutureSalt : ITLObject
    {
    ...
    public interface IFutureSalts : ITLObject
    {
		System.UInt64 ReqMsgId { get; }
    ...
    [TLType(typeof(Pong))]
    public interface IPong : ITLObject
    {
    ...
    public interface IDestroySessionRes : ITLObject
    {
		System.UInt64 SessionId { get; }
    }

    [TLType(typeof(NewSessionCreated))]
    public interface INewSession : ITLObject
    {
    ...
    public interface IMessageContainer : ITLObject
    {
    ...
    public interface IMsgResendReq : ITLObject
    {
		System.Collections.Generic.List<System.UInt64> MsgIds { get; }
    }

    [TLType(typeof(MsgsStateReq))]
    public interface IMsgsStateReq : ITLObject
    {
		System.Collections.Generic.List<System.UInt64> MsgIds { get; }
    }

    [TLType(typeof(MsgsStateInfo))]
    public interface IMsgsStateInfo : ITLObject
    {
		System.UInt64 ReqMsgId { get; }
    ...
    public interface IMsgsAllInfo : ITLObject
    {
		System.Collections.Generic.List<System.UInt64> MsgIds { get; }
		System.Byte[] Info { get; }
    }
    ...
    public interface IMsgDetailedInfo : ITLObject
    {
