...
//     Generated at 07/06/2014 19:52:42
//
...
namespace SharpMTProto.Schema.MTProto
{
    ...
    public partial class RpcResult : IRpcResult
    {
        ...
        [TLProperty(2)]
        public SharpTL.BaseTypes.ITLObject Result { get; set; }
    ...
    public partial class Message : IMessage
    {
        ...
        [TLProperty(4)]
        public SharpTL.BaseTypes.ITLObject Body { get; set; }
    ...
    [TLType(typeof(ResPQ))]
    public interface IResPQ : SharpTL.BaseTypes.ITLObject
    {
    ...
    public interface IPQInnerData : SharpTL.BaseTypes.ITLObject
    {
		System.Byte[] Pq { get; }
		System.Byte[] P { get; }
		System.Byte[] Q { get; }
    ...
    public interface IServerDHParams : SharpTL.BaseTypes.ITLObject
    {
		BigMath.Int128 Nonce { get; }
		BigMath.Int128 ServerNonce { get; }
    }
    ...
    public interface IServerDHInnerData : SharpTL.BaseTypes.ITLObject
    {
		BigMath.Int128 Nonce { get; }
		BigMath.Int128 ServerNonce { get; }
		System.UInt32 G { get; }
    ...
    public interface IClientDHInnerData : SharpTL.BaseTypes.ITLObject
    {
		BigMath.Int128 Nonce { get; }
		BigMath.Int128 ServerNonce { get; }
    ...
    public interface ISetClientDHParamsAnswer : SharpTL.BaseTypes.ITLObject
    {
		BigMath.Int128 Nonce { get; }
		BigMath.Int128 ServerNonce { get; }
    }
    ...
    public interface IRpcResult : SharpTL.BaseTypes.ITLObject
    {
		System.UInt64 ReqMsgId { get; }
		SharpTL.BaseTypes.ITLObject Result { get; }
    }

    [TLType(typeof(RpcError))]
    public interface IRpcError : SharpTL.BaseTypes.ITLObject
    {
    ...
    public interface IRpcDropAnswer : SharpTL.BaseTypes.ITLObject
    {
    }

    [TLType(typeof(FutureSalt))]
    public interface IFutureSalt : SharpTL.BaseTypes.ITLObject
    {
    ...
    public interface IFutureSalts : SharpTL.BaseTypes.ITLObject
    {
		System.UInt64 ReqMsgId { get; }
    ...
    [TLType(typeof(Pong))]
    public interface IPong : SharpTL.BaseTypes.ITLObject
    {
    ...
    public interface IDestroySessionRes : SharpTL.BaseTypes.ITLObject
    {
		System.UInt64 SessionId { get; }
    }

    [TLType(typeof(NewSessionCreated))]
    public interface INewSession : SharpTL.BaseTypes.ITLObject
    {
    ...
    public interface IMessageContainer : SharpTL.BaseTypes.ITLObject
    {
		System.Collections.Generic.List<Message> Messages { get; }
    }

    [TLType(typeof(Message))]
    public interface IMessage : SharpTL.BaseTypes.ITLObject
    {
		System.UInt64 MsgId { get; }
		System.UInt32 Seqno { get; }
		System.UInt32 Bytes { get; }
		SharpTL.BaseTypes.ITLObject Body { get; }
    }

    [TLType(typeof(MsgCopy))]
    public interface IMessageCopy : SharpTL.BaseTypes.ITLObject
    {
		IMessage OrigMessage { get; }
    }

    [TLType(typeof(MsgsAck))]
    public interface IMsgsAck : SharpTL.BaseTypes.ITLObject
    {
		System.Collections.Generic.List<System.UInt64> MsgIds { get; }
    }

    [TLType(typeof(BadMsgNotification), typeof(BadServerSalt))]
    public interface IBadMsgNotification : SharpTL.BaseTypes.ITLObject
    {
    ...
    public interface IMsgResendReq : SharpTL.BaseTypes.ITLObject
    {
		System.Collections.Generic.List<System.UInt64> MsgIds { get; }
    }

    [TLType(typeof(MsgsStateReq))]
    public interface IMsgsStateReq : SharpTL.BaseTypes.ITLObject
    {
		System.Collections.Generic.List<System.UInt64> MsgIds { get; }
    }

    [TLType(typeof(MsgsStateInfo))]
    public interface IMsgsStateInfo : SharpTL.BaseTypes.ITLObject
    {
		System.UInt64 ReqMsgId { get; }
    ...
    public interface IMsgsAllInfo : SharpTL.BaseTypes.ITLObject
    {
		System.Collections.Generic.List<System.UInt64> MsgIds { get; }
		System.Byte[] Info { get; }
    }
    ...
    public interface IMsgDetailedInfo : SharpTL.BaseTypes.ITLObject
    {
